...
from .models import League, Team, Organization, TeamSeason
...
# teams
class TeamSeasonResource(resources.ModelResource):
    class Meta:
        model = TeamSeason


class TeamSeasonAdmin(BaseResourceAdmin):
    resource_class = TeamSeasonResource
